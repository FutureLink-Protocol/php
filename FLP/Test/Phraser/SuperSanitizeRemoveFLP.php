...
class SuperSanitizeRemoveFLP extends Base
{
    public function __construct()
    {
        $this->expected = "ThisismyarticleIcantwaittoshowitoffTheend";

        $phraser = new Phraser\Phraser();

        $this->actual = $phraser->superSanitize("<p>This is my article
</p>
